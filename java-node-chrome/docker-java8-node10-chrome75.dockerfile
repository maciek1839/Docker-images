# Build command: docker build -t my-docker-image-ubuntu18-java8-node10-chrome75:1 -f docker-java8-node10-chrome75.dockerfile .
# Before building an image, log in because ubuntu registry requires it.
...
# Install Chrome v75
RUN wget https://github.com/webnicer/chrome-downloads/raw/master/x64.deb/google-chrome-stable_75.0.3770.80-1_amd64.deb \
 && dpkg -i google-chrome*.deb \
 && google-chrome --version \
 && rm google-chrome-stable_75.0.3770.80-1_amd64.deb
